...
export default function ContactSection({ contacts }: ContactSectionProps) {
  ...
  return (
    <section className="py-24 px-4 md:px-6 relative z-10 w-full flex flex-col items-center">
      <div className="max-w-4xl w-full text-center mb-12">
        ...
        >
          <h2 className="font-serif text-4xl md:text-5xl text-charcoal mb-4">Questions?</h2>
